...
<head>
    ...
    <title>Privacy Policy - Fumola Store
    </title>
    <!-- CSS files -->
    ...
    <div class="page page-center">
        <div class="container container-narrow py-4">
            <div class="text-center mb-4">
                <a href="#" class="navbar-brand navbar-brand-autodark"><img src="/img/logo.png" height="36"
                        alt=""></a>
            </div>
            <div class="card card-md">
                <div class="card-body">
                    ...
                    <div class="markdown">
                        <h1>Privacy Policy for Fumola Store</h1>

                        <p>At Fumola Store, accessible from https://fumolastore.id, one of our main priorities is the
                            privacy of our visitors. This Privacy Policy document contains types of information that is
                            collected and recorded by Fumola Store and how we use it.</p>
                        ...
                        <p>Fumola Store follows a standard procedure of using log files. These files log visitors when
                            ...
                            information. Our Privacy Policy was created with the help of the <a
                                href="https://www.privacypolicyonline.com/privacy-policy-generator/">Privacy Policy
                                Generator</a>.</p>

                        <h2>Cookies and Web Beacons</h2>

                        <p>Like any other website, Fumola Store uses "cookies". These cookies are used to store
                        ...
                        <p>For more general information on cookies, please read <a
                                href="https://www.privacypolicyonline.com/what-are-cookies/">the "Cookies" article from
                                the Privacy Policy Generator</a>.</p>
                        ...
                        <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web
                            Beacons that are used in their respective advertisements and links that appear on Fumola
                        ...
                        <p>Note that Fumola Store has no access to or control over these cookies that are used by
                            third-party advertisers.</p>

                        <h2>Third Party Privacy Policies</h2>

                        <p>Fumola Store's Privacy Policy does not apply to other advertisers or websites. Thus, we are
                        ...
                        <p>Fumola Store does not knowingly collect any Personal Identifiable Information from children
                        ...
                        <p>This Privacy Policy applies only to our online activities and is valid for visitors to our
                            website with regards to the information that they shared and/or collect in Fumola Store.
