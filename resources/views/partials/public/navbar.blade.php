    ...
    <nav class="navbar navbar-expand-lg bg-custom"
        ...
        <div class="container">
            <a class="navbar-brand" href="#">
                <a href="{{ route('home') }}">
                    <img src="/img/logo.png" width="50" height="30" alt="Tempat Top Up Murah, Nyaman, dan Cepat">
                </a>
            </a>
                    ...
                    <li class="nav-item">
                        <form action="{{ route('pencarian.index') }}" method="get">
                            <input name="keyword" type="text" class="form-control"
                                style="border-radius: 23px;border:solid 3px rgb(17, 140, 177);" placeholder="Cari Game">
                        </form>
                    </li>
