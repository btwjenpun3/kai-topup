                        ...
                        <div class="col-md-12">
                            <div class="description">
                                ...
                                <ul>
                                    ...
                                    <li>2. Masukkan UID dan Masukkan SID</li>
                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-12">
                                    <div class="data-input">
                                        <input id="userIdInput" type="text" placeholder="Masukkan UID" required />
                                    </div>
                                </div>
                                <div class="col-md-6 col-sm-12">
                                    <div class="data-input">
                                        <input id="serverIdInput" type="text" placeholder="Masukkan SID" required />
                                    </div>
                                </div>
                            </div>
                        </div>
