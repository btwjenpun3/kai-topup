                        ...
                        <div class="col-md-12">
                            <div class="description">
                                ...
                                <ul>
                                    ...
                                    <li>2. Masukkan Nomor Pelanggan</li>
                                    ...
                                    <li>6. Tunggu Beberapa Saat Kode Voucher Akan Otomatis Tercetak pada Invoice.</li>
                                </ul>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <div class="item-parent mb-4">
                    <div class="col-md-12">
                        ...
                        <div class="flex-row">
                            @foreach ($harga as $h)
                                @if ($h->status == 1 && $h->tipe == 'Umum' && $h->kode_produk != 'PLNCNTP')
                                    @php
