                        ...
                        <div class="col-md-12">
                            <div class="description">
                                ...
                                <ul>
                                    ...
                                    <li>2. Masukkan Telepon</li>
                                    <li>3. Pilih Metode Pembayaran</li>
                                    <li>4. Klik Konfirmasi Top Up & Melakukan Pembayaran </li>
                                    <li>5. Tunggu Beberapa Nomor Voucher akan Tercetak pada Invoice Anda</li>
                                </ul>
                            </div>
                        </div>
                    </div>
