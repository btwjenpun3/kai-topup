...
class TopUpController extends Controller
{
    public function index(Request $request)
    {
        ...
        if($game->slug == 'mobile-legend') {
            ...
            return view('pages.public.topup.ace-racer', [
                'now' => $now,               
                'game' => $game,
                'harga' => $harga,
                'ewallets' => Payment::where('status', 1)->where('payment_type', 'EWALLET')->get(),
            ...
            return view('pages.public.topup.astral-guardians', [
                'now' => $now,               
                'game' => $game,
                'harga' => $harga,
                'ewallets' => Payment::where('status', 1)->where('payment_type', 'EWALLET')->get(),
            ...
            return view('pages.public.topup.sky-children-of-the-light', [
                'now' => $now,               
                'game' => $game,
                'harga' => $harga,
                'ewallets' => Payment::where('status', 1)->where('payment_type', 'EWALLET')->get(),
            ...
            return view('pages.public.topup.laplace-m', [
                'now' => $now,               
                'game' => $game,
                'harga' => $harga,
                'ewallets' => Payment::where('status', 1)->where('payment_type', 'EWALLET')->get(),
            ...
            return view('pages.public.topup.mangatoon', [
                'now' => $now,               
                'game' => $game,
                'harga' => $harga,
                'ewallets' => Payment::where('status', 1)->where('payment_type', 'EWALLET')->get(),
            ...
            return view('pages.public.topup.tom-and-jerry-chase', [
                'now' => $now,               
                'game' => $game,
                'harga' => $harga,
                'ewallets' => Payment::where('status', 1)->where('payment_type', 'EWALLET')->get(),
            ...
            return view('pages.public.topup.state-of-survival', [
                'now' => $now,               
                'game' => $game,
                'harga' => $harga,
                'ewallets' => Payment::where('status', 1)->where('payment_type', 'EWALLET')->get(),
            ...
            return view('pages.public.topup.kings-choice', [
                'now' => $now,               
                'game' => $game,
                'harga' => $harga,
                'ewallets' => Payment::where('status', 1)->where('payment_type', 'EWALLET')->get(),
            ...
            return view('pages.public.topup.pubg-new-state-mobile', [
                'now' => $now,               
                'game' => $game,
                'harga' => $harga,
                'ewallets' => Payment::where('status', 1)->where('payment_type', 'EWALLET')->get(),
            ...
            return view('pages.public.topup.fc-mobile', [
                'now' => $now,               
                'game' => $game,
                'harga' => $harga,
                'ewallets' => Payment::where('status', 1)->where('payment_type', 'EWALLET')->get(),
